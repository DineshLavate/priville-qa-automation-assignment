...
public class Priville_PageObjects {
	...
	// This are the locators of Map page
    ...
    public static final By serchbox = By.xpath("//input[@placeholder='Search for venue']");
    ...
    // This are the locators on Filter your search page
    ...
    // this are the locators on Hotel/venue window
    ...
    // this are the locators on Login window
